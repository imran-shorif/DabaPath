    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonUpload.setOnClickListener(v -> {
            if (mUploadTask != null && mUploadTask.isInProgress()) {
                Toast.makeText(News.this, "Upload in progress", Toast.LENGTH_SHORT).show();
            } else {
                uploadFile();
            }
        });
        ...
        if (mImageUri != null) {
            ...
            fileReference.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(News.this, "Upload successful", Toast.LENGTH_LONG).show();
                    ...
                    }).addOnFailureListener(e -> Toast.makeText(News.this, e.getMessage(), Toast.LENGTH_SHORT).show())
